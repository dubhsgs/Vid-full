-- VAID Auth + Security Refactor Migration Draft
-- Date: 2026-05-02
-- Status: DRAFT ONLY. DO NOT RUN DIRECTLY IN PRODUCTION.
-- Location intentionally under docs/, not supabase/migrations/.
-- Purpose: reviewable SQL design for moving VAID from client_id/frontend-write architecture
...
-- 6. Final product decisions for this draft:
