  ...
  en: {
    translation: {
      ...
      form: {
        ...
        evidence: {
          title: 'Add Creation Proof Materials',
          subtitle: 'Upload video, images, or PDF files that can help support how this work was generated, edited, or saved on an AI platform.',
          guidanceTitle: 'Helpful materials usually show:',
          guidancePlatform: 'AI platform name or interface',
          guidancePrompt: 'Prompt, generation record, or work details',
          guidanceTime: 'Creation, generation, or platform record time',
          guidanceMatch: 'A screen that can correspond to the final work',
          dragDrop: 'Drag and drop proof materials here',
          fileTypes: 'Video, image, or PDF. Up to {{count}} files, {{size}} MB each.',
          selectFile: 'Select Materials',
          added: '{{count}} material added',
          remove: 'Remove',
          skip: 'Skip this step',
          continue: 'Continue',
          skipTitle: 'Skip proof materials?',
          skipMessage: 'VAID will still create the work archive and time record. If a copyright or authorship dispute happens later, the evidence chain may be less complete without additional creation materials.',
          returnUpload: 'Return to upload',
          skipConfirm: 'Skip anyway',
          types: {
            video: 'Video',
            image: 'Image',
            pdf: 'PDF'
      ...
      errors: {
        ...
        unsupportedEvidenceType: 'Please upload video, image, or PDF proof materials.',
        evidenceTooLarge: 'This proof material is too large. Please upload a file smaller than {{size}} MB.',
        evidenceTooMany: 'Please upload no more than {{count}} proof materials.',
        evidenceUploadFailed: 'Proof material upload failed. Please try again or skip this step.',
        evidenceRegisterFailed: 'Proof material registration failed. Please try again or skip this step.',
  ...
  zh: {
    translation: {
      ...
      form: {
        ...
        evidence: {
          title: '补充创作证明材料',
          subtitle: '可上传视频、图片或 PDF，用于补充记录作品在 AI 平台生成、修改或保存的过程。',
          guidanceTitle: '建议材料中尽量包含：',
          guidancePlatform: 'AI 平台名称或平台界面',
          guidancePrompt: '提示词、生成记录或作品详情',
          guidanceTime: '创作时间、生成时间或平台记录时间',
          guidanceMatch: '能够对应最终作品的画面',
          dragDrop: '将证明材料拖放到此处',
          fileTypes: '支持视频、图片或 PDF。最多 {{count}} 个文件，每个 {{size}} MB 以内。',
          selectFile: '选择材料',
          added: '已添加 {{count}} 份材料',
          remove: '移除',
          skip: '跳过此步',
          continue: '继续生成',
          skipTitle: '跳过证明材料？',
          skipMessage: 'VAID 仍会生成作品档案和时间记录。但如果未来发生版权或归属争议，未补充创作证明材料时，证据链可能不如已上传材料完整。',
          returnUpload: '返回上传',
          skipConfirm: '仍然跳过',
          types: {
            video: '视频',
      ...
      errors: {
        ...
        unsupportedEvidenceType: '请上传视频、图片或 PDF 证明材料',
        evidenceTooLarge: '该证明材料过大，请上传小于 {{size}} MB 的文件',
        evidenceTooMany: '证明材料最多上传 {{count}} 个文件',
        evidenceUploadFailed: '证明材料上传失败，请重试或跳过此步',
        evidenceRegisterFailed: '证明材料登记失败，请重试或跳过此步',
  ...
  ja: {
    translation: {
      ...
      form: {
        ...
        evidence: {
          title: '制作証明資料を追加',
          subtitle: 'AIプラットフォームで作品が生成、修正、保存された過程を補足する動画、画像、PDFをアップロードできます。',
          guidanceTitle: '資料にはできるだけ以下を含めてください：',
          guidancePlatform: 'AIプラットフォーム名または画面',
          guidancePrompt: 'プロンプト、生成記録、作品詳細',
          guidanceTime: '制作、生成、またはプラットフォーム記録時刻',
          guidanceMatch: '最終作品と対応できる画面',
          dragDrop: '証明資料をここにドラッグ＆ドロップ',
          fileTypes: '動画、画像、PDFに対応。最大{{count}}ファイル、各{{size}} MBまで。',
          selectFile: '資料を選択',
          added: '{{count}}件の資料を追加済み',
          remove: '削除',
          skip: 'この手順をスキップ',
          continue: '生成を続ける',
          skipTitle: '証明資料をスキップしますか？',
          skipMessage: 'VAIDは引き続き作品アーカイブと時刻記録を作成します。ただし、後日著作権や作者性の争いが発生した場合、追加の制作証明資料がないと証拠チェーンが不完全になる可能性があります。',
          returnUpload: 'アップロードに戻る',
          skipConfirm: 'スキップする',
          types: {
            video: '動画',
            image: '画像',
      ...
      errors: {
        ...
        unsupportedEvidenceType: '動画、画像、またはPDFの証明資料をアップロードしてください。',
        evidenceTooLarge: 'この証明資料は大きすぎます。{{size}} MB未満のファイルをアップロードしてください。',
        evidenceTooMany: '証明資料は最大{{count}}件までアップロードできます。',
        evidenceUploadFailed: '証明資料のアップロードに失敗しました。もう一度試すか、この手順をスキップしてください。',
        evidenceRegisterFailed: '証明資料の登録に失敗しました。もう一度試すか、この手順をスキップしてください。',
