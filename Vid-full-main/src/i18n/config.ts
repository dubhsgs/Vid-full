  ...
  en: {
    translation: {
      ...
      auth: {
        ...
        magicLinkInvalid: 'This sign-in link has expired. Please send yourself a new magic link.',
        sending: 'Sending...',
  ...
  zh: {
    translation: {
      ...
      auth: {
        ...
        magicLinkInvalid: '这封邮件里的登录链接已经失效，请重新发送一封新的登录链接。',
        sending: '发送中...',
  ...
  ja: {
    translation: {
      ...
      auth: {
        ...
        magicLinkInvalid: 'このログインリンクは期限切れです。新しいログインリンクを送信してください。',
        sending: '送信中...',
