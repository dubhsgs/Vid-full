  ...
  en: {
    translation: {
      ...
      errors: {
        ...
        identitySaveFailed: 'Creation proof materials could not be saved. Please try again.',
  ...
  zh: {
    translation: {
      ...
      errors: {
        ...
        identitySaveFailed: '创作证明材料保存失败，请重试',
  ...
  ja: {
    translation: {
      ...
      errors: {
        ...
        identitySaveFailed: '制作証明資料を保存できませんでした。再試行してください。',
