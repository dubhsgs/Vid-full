  ...
  en: {
    translation: {
      ...
      form: {
        ...
        countryRegionPlaceholder: 'e.g., United States',
      ...
      errors: {
        ...
        identitySaveFailed: 'Private identity information could not be saved. Please try again.',
  ...
  zh: {
    translation: {
      ...
      form: {
        ...
        countryRegion: '国家 / 地区',
        countryRegionPlaceholder: '例如：中国',
        documentType: '证件类型',
      ...
      errors: {
        ...
        identitySaveFailed: '私有身份资料保存失败，请重试',
  ...
  ja: {
    translation: {
      ...
      errors: {
        ...
        identitySaveFailed: '非公開の本人確認情報を保存できませんでした。再試行してください。',
